...
#    Updated: 2019/11/07 23:25:13 by sselusa          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MEMORY_OBJ_PATHS = $(patsubst $(MEMORY_SRC_DIR)/%.c,$(MEMORY_OBJ_DIR)/%.o, $(MEMORY_SRC_PATHS))
...
CHAR_OBJ_PATHS = $(patsubst $(CHAR_SRC_DIR)/%.c,$(CHAR_OBJ_DIR)/%.o, $(CHAR_SRC_PATHS))
...
STRING_OBJ_PATHS = $(patsubst $(STRING_SRC_DIR)/%.c,$(STRING_OBJ_DIR)/%.o, $(STRING_SRC_PATHS))
...
XTOY_OBJ_PATHS = $(patsubst $(XTOY_SRC_DIR)/%.c, $(XTOY_OBJ_DIR)/%.o, $(XTOY_SRC_PATHS))
...
OUTPUT_OBJ_PATHS = $(patsubst $(OUTPUT_SRC_DIR)/%.c,$(OUTPUT_OBJ_DIR)/%.o, $(OUTPUT_SRC_PATHS))
...
LIST_OBJ_PATHS = $(patsubst $(LIST_SRC_DIR)/%.c,$(LIST_OBJ_DIR)/%.o, $(LIST_SRC_PATHS))
LIST_DEPS = $(LIST_OBJ_PATHS:.o=.d)

OBJS = $(MEMORY_OBJ_PATHS) $(CHAR_OBJ_PATHS) $(STRING_OBJ_PATHS) $(XTOY_OBJ_PATHS) $(OUTPUT_OBJ_PATHS) $(LIST_OBJ_PATHS)
